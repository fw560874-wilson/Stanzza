...
export const projects: Project[] = [
  {
    ...
    country: "Spain",
    image: images.pau,
    gallery: [images.pau, images.pauDetail, images.pauAlt, images.hero],
    accent: "#7A8452",
    client:
  ...
  },
  {
    ...
    gallery: [images.valencia, images.pauAlt, images.hero],
    accent: "#2C3C66",
    client:
  ...
  },
  {
    ...
    image: images.chok,
    gallery: [images.chok, images.dose, images.jazean],
    accent: "#8A6A4A",
  ...
  },
  {
    ...
    country: "Saudi Arabia",
    image: images.jazean,
    gallery: [images.jazean, images.chok, images.dose],
    accent: "#4A5340",
  ...
  },
  {
    ...
    country: "Saudi Arabia",
    image: images.dose,
    gallery: [images.dose, images.jazean, images.chok],
    accent: "#3D2C24",
